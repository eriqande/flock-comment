...
One of the major claimed advantages of {\sc flock} over other methods for genetic clustering
...
genotype a large number of individuals for a great many number of loci, may render this advantage less relevant to many 
...
The development of software to analyze genetic data is ever increasing. In the face of a growing
