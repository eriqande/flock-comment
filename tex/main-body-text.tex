...
by a 200,000 sweep sample from the posterior of $K$ from 1 to K+3. 
...
drastically different plateau sequences with just two clusters and that as $K$ increases
...
allocations will provide no support to a given $K$.
