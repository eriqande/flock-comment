...
produce roughtly equivalent results at higher levels of population differentiation. At intermediate 
values, the variance of the loss incurred by each model increases and certain models do marginally
better in assignment. No model does consistently better than the others, until $F_{ST}$ drops 
