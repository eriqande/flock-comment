...
gray-scale vertical bar. The numbers in parentheses on the right indicate how many {\sc structure} runs (out of 6, as indicated) reached the same solution, or how many groups of {\sc flock} runs (out of 6) had the same ``best run.''}
    \label{fig:qplots}
\end{center}
\end{figure*}
