...
membership to each $K$ clusters scaled to sum to one) for a run belonging to the longest plateau.
...
allocation of indivividuals into K clusters between each program. For all six groups 
...
\begin{center}
 ...
 \includegraphics[width=25em]{images/Figures-Pat/Fig2.eps}
