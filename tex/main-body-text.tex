...
to becoming trapped in local modes of the posterior probability, though
the practical implications of that are not yet clear.
...
different solutions in complex spaces; however our simulationssuggest this is a more  
...
{\sc flock} were to be implemented using good coding practices in a fast language, rather than as
a VBA routine in Microsoft Excel,
it would be approximately 200 times faster. This is not an inconsequential difference and is one reason
we used {\sc flockture} for a large-scale simulation assessment of the {\sc flock} algorithm.
